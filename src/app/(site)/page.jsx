...
export default function Home() {
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const mappedProducts = data.map((product) => ({
          ...
          brand: "Premium Brand", // API doesn't provide brand, using default
          description: product.description,
          price: product.price,
          categoryId: product.categoryId,
          imageUrl: product.imageUrl,
          star: product.star,
          essentialsTag: "skincare", // Default tag for essentials filter
        }));
  ...
  return (
    <div className="bg-[#fafafa]">
      ...
      {session && !loading && <LandingEssentialComponent products={products} />}
